...
const pillars: PillarData[] = [
  {
    ...
    ctaText: "Consultar servicios en CANEM",
    ctaAction: "#canem-hospital",
  ...
  },
  {
    ...
    ctaText: "Evaluar caso biomecánico",
    ctaAction: whatsappLink("Hola Dr. Fernando, me gustaría consultar por una evaluación de prótesis/órtesis para mi mascota."),
